...
However, the visual check of the resulting mixture approximation appears to be unusual:
```{r, eval=rbest_avail}
plot(plot(mix7)$mix)
```

And, further, `RBesT::ess()` results in an error when using this mixture:
