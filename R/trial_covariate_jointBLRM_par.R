...
#----------------------------------------
#'@keywords internal
trial_covariate_jointBLRM_par<- function(
                                     doses.mono1.a = c(0),
                                     doses.mono2.a = c(1),
    ...
    if(is.list(historical.data)){
        ...
        data.cov <- historical.data$covar
    ...
    prep.data.study <- c(data.study[which(is.na(data.doses.2))],
                         ...
                         rep(0, times = 2*(max.n.mono1.a+max.n.mono1.b+max.n.mono2.a+max.n.mono2.b+
                                 max.n.combi.a+max.n.combi.b)+1) )
    prep.data.cov <- c(data.cov[which(is.na(data.doses.2))],
                       data.cov[which(is.na(data.doses.1))],
                       data.cov[which(!is.na(data.doses.1) & !is.na(data.doses.2))],
                       rep(0, times = 2*(max.n.mono1.a+max.n.mono1.b+max.n.mono2.a+max.n.mono2.b+
                                             max.n.combi.a+max.n.combi.b)+1)
    ...
    while( ((!combi.is.MTD.1[1]) & n.pat[3] < max.n.combi.a & !combi.stopped.1 & active.combi.a) ||
        ...
        if((cohort.queue[cohort.counter]==3) &
           (!(combi.is.MTD.1[1]) &
            ...
            prep.data.cov[curr.data.entry] <- cov.combi.a
            ...
            current.results <- main_covariate_jointBLRM(dose1 = prep.data.doses.1[1:curr.data.entry],
                                              ...
                                              cov = prep.data.cov[1:curr.data.entry],
                                              two_sided1 = two_sided1,
                                              two_sided2 = two_sided2,
                                              cov.interest = cov.combi.a,
                                              prior.tau=prior.tau,
                                              prior.mu = prior.mu,
    ...
    #---------------------------------------------------------------------------------------------------------------------------------------------
                ...
                prep.data.cov[curr.data.entry] <- cov.combi.b
...
#---------------------------------------------------------------------------------------------------------------------------------------------
            ...
            prep.data.cov[curr.data.entry] <- cov.mono1.a
...
#---------------------------------------------------------------------------------------------------------------------------------------------
            ...
            prep.data.cov[curr.data.entry] <- cov.mono1.b
...
#---------------------------------------------------------------------------------------------------------------------------------------------
            ...
            prep.data.cov[curr.data.entry] <- cov.mono2.a
...
#---------------------------------------------------------------------------------------------------------------------------------------------
            ...
            prep.data.cov[curr.data.entry] <- cov.mono2.b
