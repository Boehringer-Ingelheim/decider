...
#'
#'Note that the function \code{sim_jointBLRM()} uses the foreach framework to allow parallelized
...
#'@param refresh Optional integer, defaults to \code{0}. The parameter is given to the \code{\link[rstan:stanmodel-method-sampling]{rstan::sampling}()}
