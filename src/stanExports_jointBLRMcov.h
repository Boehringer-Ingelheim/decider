...
namespace model_jointBLRMcov_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_jointBLRMcov");
    reader.add_event(313, 311, "end", "model_jointBLRMcov");
    return reader;
}
...
class model_jointBLRMcov
  : public stan::model::model_base_crtp<model_jointBLRMcov> {
private:
        int n_obs;
        int n_studies;
        std::vector<int> n;
...
public:
    model_jointBLRMcov(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_jointBLRMcov_namespace::model_jointBLRMcov";
        ...
        try {
            ...
            validate_non_negative_index("c", "n_obs", n_obs);
            context__.validate_dims("data initialization", "c", "int", context__.to_vec(n_obs));
            c = std::vector<int>(n_obs, int(0));
            vals_i__ = context__.vals_i("c");
            pos__ = 0;
            size_t c_k_0_max__ = n_obs;
            for (size_t k_0__ = 0; k_0__ < c_k_0_max__; ++k_0__) {
                c[k_0__] = vals_i__[pos__++];
            }
            size_t c_i_0_max__ = n_obs;
            for (size_t i_0__ = 0; i_0__ < c_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "c[i_0__]", c[i_0__], 0);
                check_less_or_equal(function__, "c[i_0__]", c[i_0__], 1);
            }
            ...
            context__.validate_dims("data initialization", "twoside1", "int", context__.to_vec());
            twoside1 = int(0);
            vals_i__ = context__.vals_i("twoside1");
            pos__ = 0;
            twoside1 = vals_i__[pos__++];
            check_greater_or_equal(function__, "twoside1", twoside1, 0);
            check_less_or_equal(function__, "twoside1", twoside1, 1);
            current_statement_begin__ = 80;
            context__.validate_dims("data initialization", "twoside2", "int", context__.to_vec());
            twoside2 = int(0);
            vals_i__ = context__.vals_i("twoside2");
            pos__ = 0;
            twoside2 = vals_i__[pos__++];
            check_greater_or_equal(function__, "twoside2", twoside2, 0);
            check_less_or_equal(function__, "twoside2", twoside2, 1);
            ...
            validate_non_negative_index("mean_tau", "7", 7);
            context__.validate_dims("data initialization", "mean_tau", "vector_d", context__.to_vec(7));
            mean_tau = Eigen::Matrix<double, Eigen::Dynamic, 1>(7);
            vals_r__ = context__.vals_r("mean_tau");
            pos__ = 0;
            size_t mean_tau_j_1_max__ = 7;
            for (size_t j_1__ = 0; j_1__ < mean_tau_j_1_max__; ++j_1__) {
                mean_tau(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 96;
            validate_non_negative_index("sd_tau", "7", 7);
            context__.validate_dims("data initialization", "sd_tau", "vector_d", context__.to_vec(7));
            sd_tau = Eigen::Matrix<double, Eigen::Dynamic, 1>(7);
            vals_r__ = context__.vals_r("sd_tau");
            pos__ = 0;
            size_t sd_tau_j_1_max__ = 7;
            ...
            validate_non_negative_index("mean_mu", "7", 7);
            context__.validate_dims("data initialization", "mean_mu", "vector_d", context__.to_vec(7));
            mean_mu = Eigen::Matrix<double, Eigen::Dynamic, 1>(7);
            vals_r__ = context__.vals_r("mean_mu");
            pos__ = 0;
            size_t mean_mu_j_1_max__ = 7;
            for (size_t j_1__ = 0; j_1__ < mean_mu_j_1_max__; ++j_1__) {
                mean_mu(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 100;
            validate_non_negative_index("sd_mu", "7", 7);
            context__.validate_dims("data initialization", "sd_mu", "vector_d", context__.to_vec(7));
            sd_mu = Eigen::Matrix<double, Eigen::Dynamic, 1>(7);
            vals_r__ = context__.vals_r("sd_mu");
            pos__ = 0;
            size_t sd_mu_j_1_max__ = 7;
            ...
            validate_non_negative_index("c_srt", "n_obs", n_obs);
            c_srt = std::vector<int>(n_obs, int(0));
            stan::math::fill(c_srt, std::numeric_limits<int>::min());
            stan::math::assign(c_srt,stan::model::rvalue(c, stan::model::cons_list(stan::model::index_multi(stan::model::rvalue(srt_idx, stan::model::cons_list(stan::model::index_uni(1), stan::model::cons_list(stan::model::index_min_max(1, n_obs), stan::model::nil_index_list())), "srt_idx")), stan::model::nil_index_list()), "c"));
            current_statement_begin__ = 116;
            validate_non_negative_index("vc_srt", "n_obs", n_obs);
            vc_srt = Eigen::Matrix<double, Eigen::Dynamic, 1>(n_obs);
            stan::math::fill(vc_srt, DUMMY_VAR__);
            stan::math::assign(vc_srt,to_vector(c_srt));
            ...
            validate_non_negative_index("log_ab_raw", "7", 7);
            num_params_r__ += (num_s * 7);
            current_statement_begin__ = 143;
            validate_non_negative_index("mu_raw", "7", 7);
            num_params_r__ += (1 * 7);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 131;
        if (!(context__.contains_r("tau_1c")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable tau_1c missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("tau_1c");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "tau_1c", "double", context__.to_vec());
        double tau_1c(0);
        tau_1c = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, tau_1c);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable tau_1c: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 132;
        if (!(context__.contains_r("tau_2c")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable tau_2c missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("tau_2c");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "tau_2c", "double", context__.to_vec());
        double tau_2c(0);
        tau_2c = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, tau_2c);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable tau_2c: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 134;
        ...
        validate_non_negative_index("log_ab_raw", "num_s", num_s);
        validate_non_negative_index("log_ab_raw", "7", 7);
        context__.validate_dims("parameter initialization", "log_ab_raw", "matrix_d", context__.to_vec(num_s,7));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> log_ab_raw(num_s, 7);
        size_t log_ab_raw_j_2_max__ = 7;
        ...
        pos__ = 0U;
        validate_non_negative_index("mu_raw", "7", 7);
        context__.validate_dims("parameter initialization", "mu_raw", "double", context__.to_vec(7));
        std::vector<double> mu_raw(7, double(0));
        size_t mu_raw_k_0_max__ = 7;
        for (size_t k_0__ = 0; k_0__ < mu_raw_k_0_max__; ++k_0__) {
            mu_raw[k_0__] = vals_r__[pos__++];
        }
        size_t mu_raw_i_0_max__ = 7;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 131;
            local_scalar_t__ tau_1c;
            (void) tau_1c;  // dummy to suppress unused var warning
            if (jacobian__)
                tau_1c = in__.scalar_lb_constrain(0, lp__);
            else
                tau_1c = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 132;
            local_scalar_t__ tau_2c;
            (void) tau_2c;  // dummy to suppress unused var warning
            if (jacobian__)
                tau_2c = in__.scalar_lb_constrain(0, lp__);
            else
                tau_2c = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 134;
            ...
            if (jacobian__)
                log_ab_raw = in__.matrix_constrain(num_s, 7, lp__);
            else
                log_ab_raw = in__.matrix_constrain(num_s, 7);
            current_statement_begin__ = 143;
            std::vector<local_scalar_t__> mu_raw;
            size_t mu_raw_d_0_max__ = 7;
            ...
            local_scalar_t__ mu_1c;
            (void) mu_1c;  // dummy to suppress unused var warning
            stan::math::initialize(mu_1c, DUMMY_VAR__);
            stan::math::fill(mu_1c, DUMMY_VAR__);
            current_statement_begin__ = 152;
            local_scalar_t__ mu_2c;
            (void) mu_2c;  // dummy to suppress unused var warning
            stan::math::initialize(mu_2c, DUMMY_VAR__);
            stan::math::fill(mu_2c, DUMMY_VAR__);
            current_statement_begin__ = 154;
            validate_non_negative_index("log_ab", "num_s", num_s);
            validate_non_negative_index("log_ab", "7", 7);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> log_ab(num_s, 7);
            ...
            stan::math::assign(mu_1c, (get_base1(mean_mu, 6, "mean_mu", 1) + (get_base1(sd_mu, 6, "sd_mu", 1) * get_base1(mu_raw, 6, "mu_raw", 1))));
            current_statement_begin__ = 167;
            stan::math::assign(mu_2c, (get_base1(mean_mu, 7, "mean_mu", 1) + (get_base1(sd_mu, 7, "sd_mu", 1) * get_base1(mu_raw, 7, "mu_raw", 1))));
            ...
            stan::model::assign(log_ab, 
                        stan::model::cons_list(stan::model::index_min_max(1, num_s), stan::model::cons_list(stan::model::index_uni(6), stan::model::nil_index_list())), 
                        add(mu_1c, multiply(tau_1c, stan::model::rvalue(log_ab_raw, stan::model::cons_list(stan::model::index_min_max(1, num_s), stan::model::cons_list(stan::model::index_uni(6), stan::model::nil_index_list())), "log_ab_raw"))), 
                        "assigning variable log_ab");
            current_statement_begin__ = 191;
            stan::model::assign(log_ab, 
                        stan::model::cons_list(stan::model::index_min_max(1, num_s), stan::model::cons_list(stan::model::index_uni(7), stan::model::nil_index_list())), 
                        add(mu_2c, multiply(tau_2c, stan::model::rvalue(log_ab_raw, stan::model::cons_list(stan::model::index_min_max(1, num_s), stan::model::cons_list(stan::model::index_uni(7), stan::model::nil_index_list())), "log_ab_raw"))), 
                        "assigning variable log_ab");
            ...
            if (as_bool(logical_gt(n_obs1, 0))) {
                ...
                if (as_bool(twoside1)) {
                    ...
                    stan::model::assign(p_srt, 
                                ...
                                inv_logit(add(add(stan::model::rvalue(log_ab, stan::model::cons_list(stan::model::index_multi(stan::model::rvalue(s_srt, stan::model::cons_list(stan::model::index_min_max(1, n_obs1), stan::model::nil_index_list()), "s_srt")), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), "log_ab"), elt_multiply(stan::model::rvalue(log_ab, stan::model::cons_list(stan::model::index_multi(stan::model::rvalue(s_srt, stan::model::cons_list(stan::model::index_min_max(1, n_obs1), stan::model::nil_index_list()), "s_srt")), stan::model::cons_list(stan::model::index_uni(6), stan::model::nil_index_list())), "log_ab"), stan::model::rvalue(vc_srt, stan::model::cons_list(stan::model::index_min_max(1, n_obs1), stan::model::nil_index_list()), "vc_srt"))), elt_multiply(stan::math::exp(stan::model::rvalue(log_ab, stan::model::cons_list(stan::model::index_multi(stan::model::rvalue(s_srt, stan::model::cons_list(stan::model::index_min_max(1, n_obs1), stan::model::nil_index_list()), "s_srt")), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), "log_ab")), stan::model::rvalue(ldose_1_srt, stan::model::cons_list(stan::model::index_min_max(1, n_obs1), stan::model::nil_index_list()), "ldose_1_srt")))), 
            ...
            if (as_bool(logical_gt(n_obs2, 0))) {
                ...
                if (as_bool(twoside2)) {
                    ...
                    stan::model::assign(p_srt, 
                                ...
                                inv_logit(add(add(stan::model::rvalue(log_ab, stan::model::cons_list(stan::model::index_multi(stan::model::rvalue(s_srt, stan::model::cons_list(stan::model::index_min_max((n_obs1 + 1), (n_obs1 + n_obs2)), stan::model::nil_index_list()), "s_srt")), stan::model::cons_list(stan::model::index_uni(3), stan::model::nil_index_list())), "log_ab"), elt_multiply(stan::model::rvalue(log_ab, stan::model::cons_list(stan::model::index_multi(stan::model::rvalue(s_srt, stan::model::cons_list(stan::model::index_min_max((n_obs1 + 1), (n_obs1 + n_obs2)), stan::model::nil_index_list()), "s_srt")), stan::model::cons_list(stan::model::index_uni(7), stan::model::nil_index_list())), "log_ab"), stan::model::rvalue(vc_srt, stan::model::cons_list(stan::model::index_min_max((n_obs1 + 1), (n_obs1 + n_obs2)), stan::model::nil_index_list()), "vc_srt"))), elt_multiply(stan::math::exp(stan::model::rvalue(log_ab, stan::model::cons_list(stan::model::index_multi(stan::model::rvalue(s_srt, stan::model::cons_list(stan::model::index_min_max((n_obs1 + 1), (n_obs1 + n_obs2)), stan::model::nil_index_list()), "s_srt")), stan::model::cons_list(stan::model::index_uni(4), stan::model::nil_index_list())), "log_ab")), stan::model::rvalue(ldose_2_srt, stan::model::cons_list(stan::model::index_min_max((n_obs1 + 1), (n_obs1 + n_obs2)), stan::model::nil_index_list()), "ldose_2_srt")))), 
                                "assigning variable p_srt");
                } else {
            ...
            current_statement_begin__ = 151;
            if (stan::math::is_uninitialized(mu_1c)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: mu_1c";
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable mu_1c: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            current_statement_begin__ = 152;
            if (stan::math::is_uninitialized(mu_2c)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: mu_2c";
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable mu_2c: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            current_statement_begin__ = 154;
            size_t log_ab_j_1_max__ = num_s;
            size_t log_ab_j_2_max__ = 7;
            ...
            lp_accum__.add(lognormal_log<propto__>(tau_1c, get_base1(mean_tau, 6, "mean_tau", 1), get_base1(sd_tau, 6, "sd_tau", 1)));
            current_statement_begin__ = 295;
            lp_accum__.add(lognormal_log<propto__>(tau_2c, get_base1(mean_tau, 7, "mean_tau", 1), get_base1(sd_tau, 7, "sd_tau", 1)));
            ...
            for (int k = 1; k <= num_s; ++k) {
                ...
                lp_accum__.add(std_normal_log<propto__>(stan::model::rvalue(log_ab_raw, stan::model::cons_list(stan::model::index_uni(k), stan::model::cons_list(stan::model::index_min_max(1, 7), stan::model::nil_index_list())), "log_ab_raw")));
            }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("tau_1c");
        names__.push_back("tau_2c");
        ...
        names__.push_back("mu_1c");
        names__.push_back("mu_2c");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_jointBLRMcov_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double tau_1c = in__.scalar_lb_constrain(0);
        vars__.push_back(tau_1c);
        double tau_2c = in__.scalar_lb_constrain(0);
        vars__.push_back(tau_2c);
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> log_ab_raw = in__.matrix_constrain(num_s, 7);
        size_t log_ab_raw_j_2_max__ = 7;
        size_t log_ab_raw_j_1_max__ = num_s;
        for (size_t j_2__ = 0; j_2__ < log_ab_raw_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < log_ab_raw_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            validate_non_negative_index("log_ab", "num_s", num_s);
            validate_non_negative_index("log_ab", "7", 7);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> log_ab(num_s, 7);
            stan::math::initialize(log_ab, DUMMY_VAR__);
            stan::math::fill(log_ab, DUMMY_VAR__);
            current_statement_begin__ = 155;
            validate_non_negative_index("p_srt", "n_obs", n_obs);
            ...
            if (include_tparams__) {
                ...
                vars__.push_back(mu_1c);
                vars__.push_back(mu_2c);
                size_t log_ab_j_2_max__ = 7;
                size_t log_ab_j_1_max__ = num_s;
                for (size_t j_2__ = 0; j_2__ < log_ab_j_2_max__; ++j_2__) {
                    for (size_t j_1__ = 0; j_1__ < log_ab_j_1_max__; ++j_1__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "tau_1c";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "tau_2c";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        ...
        if (include_tparams__) {
            ...
            param_names__.push_back(param_name_stream__.str());
            param_name_stream__.str(std::string());
            param_name_stream__ << "mu_1c";
            param_names__.push_back(param_name_stream__.str());
            param_name_stream__.str(std::string());
            param_name_stream__ << "mu_2c";
            param_names__.push_back(param_name_stream__.str());
            size_t log_ab_j_2_max__ = 7;
            size_t log_ab_j_1_max__ = num_s;
            for (size_t j_2__ = 0; j_2__ < log_ab_j_2_max__; ++j_2__) {
...
typedef model_jointBLRMcov_namespace::model_jointBLRMcov stan_model;
#ifndef USING_R
