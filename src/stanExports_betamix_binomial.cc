...
#include "stanExports_betamix_binomial.h"

RCPP_MODULE(stan_fit4betamix_binomial_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_betamix_binomial")
